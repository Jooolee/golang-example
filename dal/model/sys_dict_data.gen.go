...
type SysDictDatum struct {
	DictCode   int64     `gorm:"column:dict_code;primaryKey;autoIncrement:true;comment:字典编码" json:"dict_code"` // 字典编码
	...
	IsDefault  string    `gorm:"column:is_default;default:N;comment:是否默认（Y是 N否）" json:"is_default"`            // 是否默认（Y是 N否）
