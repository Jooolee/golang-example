...
type SysConfig struct {
	ConfigID    int32     `gorm:"column:config_id;primaryKey;autoIncrement:true;comment:参数主键" json:"config_id"` // 参数主键
	...
	ConfigType  string    `gorm:"column:config_type;default:N;comment:系统内置（Y是 N否）" json:"config_type"`          // 系统内置（Y是 N否）
