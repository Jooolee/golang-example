...
// SysMenu 菜单权限表
type SysMenu struct {
	MenuID     int64     `gorm:"column:menu_id;primaryKey;autoIncrement:true;comment:菜单ID" json:"menu_id"` // 菜单ID
	...
	URL        string    `gorm:"column:url;default:#;comment:请求地址" json:"url"`                             // 请求地址
	...
	Icon       string    `gorm:"column:icon;default:#;comment:菜单图标" json:"icon"`                           // 菜单图标
